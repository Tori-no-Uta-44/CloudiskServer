...
public:
	...
	virtual void Signin(ReqSignin *request, RespSignup *response,
...
using SigninDone = std::function<void (RespSignup *, srpc::RPCContext *)>;

class SRPCClient : public srpc::SRPCClient
{
public:
	void Signin(const ReqSignin *req, SigninDone done);
	void Signin(const ReqSignin *req, RespSignup *resp, srpc::RPCSyncContext *sync_ctx);
	WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> async_Signin(const ReqSignin *req);
...
inline void SRPCClient::Signin(const ReqSignin *req, RespSignup *resp, srpc::RPCSyncContext *sync_ctx)
{
...
inline WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> SRPCClient::async_Signin(const ReqSignin *req)
{
	using RESULT = std::pair<RespSignup, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
	auto *task = this->create_rpc_client_task<RespSignup>("Signin", srpc::RPCAsyncFutureCallback<RespSignup>);
...
inline void SRPCHttpClient::Signin(const ReqSignin *req, RespSignup *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Signin(req).get();
...
inline WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> SRPCHttpClient::async_Signin(const ReqSignin *req)
{
	using RESULT = std::pair<RespSignup, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
...
inline void BRPCClient::Signin(const ReqSignin *req, RespSignup *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Signin(req).get();
...
inline WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> BRPCClient::async_Signin(const ReqSignin *req)
{
	using RESULT = std::pair<RespSignup, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
...
{
	auto *task = this->create_rpc_client_task("/UserService/Signin", std::move(done));
...
inline void TRPCClient::Signin(const ReqSignin *req, RespSignup *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Signin(req).get();
...
inline WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> TRPCClient::async_Signin(const ReqSignin *req)
{
	using RESULT = std::pair<RespSignup, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
	auto *task = this->create_rpc_client_task<RespSignup>("/UserService/Signin", srpc::RPCAsyncFutureCallback<RespSignup>);
...
inline void TRPCHttpClient::Signin(const ReqSignin *req, RespSignup *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Signin(req).get();
...
inline WFFuture<std::pair<RespSignup, srpc::RPCSyncContext>> TRPCHttpClient::async_Signin(const ReqSignin *req)
{
	using RESULT = std::pair<RespSignup, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
