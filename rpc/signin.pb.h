...
// string information = 2;
inline void RespSignup::clear_information() {
  information_.ClearToEmpty();
}
inline const std::string& RespSignup::information() const {
  // @@protoc_insertion_point(field_get:RespSignup.information)
  return _internal_information();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RespSignup::set_information(ArgT0&& arg0, ArgT... args) {
 
 information_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:RespSignup.information)
}
inline std::string* RespSignup::mutable_information() {
  std::string* _s = _internal_mutable_information();
  // @@protoc_insertion_point(field_mutable:RespSignup.information)
  return _s;
}
inline const std::string& RespSignup::_internal_information() const {
  return information_.Get();
}
inline void RespSignup::_internal_set_information(const std::string& value) {
  
  information_.Set(value, GetArenaForAllocation());
}
inline std::string* RespSignup::_internal_mutable_information() {
  
  return information_.Mutable(GetArenaForAllocation());
}
inline std::string* RespSignup::release_information() {
  // @@protoc_insertion_point(field_release:RespSignup.information)
  return information_.Release();
}
inline void RespSignup::set_allocated_information(std::string* information) {
  if (information != nullptr) {
    
  } else {
    
  }
  information_.SetAllocated(information, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (information_.IsDefault()) {
    information_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:RespSignup.information)
}
