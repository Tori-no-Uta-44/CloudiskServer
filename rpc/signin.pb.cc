...
PROTOBUF_CONSTEXPR RespSignup::RespSignup(
    ::_pbi::ConstantInitialized)
  : information_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , code_(0){}
...
const uint32_t TableStruct_signin_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::RespSignup, information_),
};
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "RespSignup.information"));
        } else
          goto handle_unusual;
        continue;
      default:
...
void RespSignup::InternalSwap(RespSignup* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &information_, lhs_arena,
      &other->information_, rhs_arena
  );
