...
public:
	...
	friend void LogInfo(const string& buffer);

	friend void LogError(const string& buffer);

	friend void LogWarn(const string& buffer);

	friend void LogDebug(const string& buffer);

	friend void LogFatal(const string& buffer);

	friend void LogCrit(const string& buffer);
...
void LogInfo(const string& buffer) {
	const Mylogger* log = Mylogger::getInstance();
	log->info(buffer);
}

void LogError(const string& buffer) {
	const Mylogger* log = Mylogger::getInstance();
	log->error(buffer);
}

void LogWarn(const string& buffer) {
	const Mylogger* log = Mylogger::getInstance();
	log->warn(buffer);
}

void LogDebug(const string& buffer) {
	const Mylogger* log = Mylogger::getInstance();
	log->debug(buffer);
}

void LogFatal(const string& buffer) {
	const Mylogger* log = Mylogger::getInstance();
	log->fatal(buffer);
}

void LogCrit(const string& buffer) {
	const Mylogger* log = Mylogger::getInstance();
	log->crit(buffer);
}
